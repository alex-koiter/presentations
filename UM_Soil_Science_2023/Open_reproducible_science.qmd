...
::: {style="position:absolute; bottom:0"}
 `r icons::fontawesome("globe")` [**alexkoiter.ca**](https://alexkoiter.ca){.white .shadow}<br> `r icons::fontawesome("twitter")` [**\@alex_koiter**](https://twitter.com/alex_koiter){.white .shadow}<br> `r icons::fontawesome("envelope")` [**koitera\@brandonu.ca**](mailto:koitera@brandonu.ca){.white .shadow}<br> `r icons::fontawesome("github")` [**alex-koiter**](https://github.com/alex-koiter){.white .shadow}
:::
...
::: {.absolute bottom="150" right="0" width="60%"}
![Nami the soil science cat](figs/cat.gif)
:::

::: {style="position:absolute; bottom:10%"}
 `r icons::fontawesome("globe")` [**alexkoiter.ca**](https://alexkoiter.ca)<br> `r icons::fontawesome("twitter")` [**\@alex_koiter**](https://twitter.com/alex_koiter)<br> `r icons::fontawesome("envelope")` [**koitera\@brandonu.ca**](mailto:koitera@brandonu.ca)<br> `r icons::fontawesome("github")` [**alex-koiter**](https://github.com/alex-koiter)
:::
