...
# Examples of what is possible with Quarto
...
- Great for including equations and Greek letters
```{md, eval = FALSE, echo = TRUE}
...
## Lectures - Real data
- Download and visualize public data
```{md, eval = FALSE, echo = TRUE}
...
- I can create my own custom figures
```{md, eval = FALSE, echo = TRUE}
- $u_s = \frac{\rho_p-\rho_fgr^2}{18\mu}$

temp2 <- data.frame (size = seq(0.001, 1, 0.001)) %>%
...
## Assignments
- Creating and keeping real world data sets up to date
  - Included in the same `qmd` file as the instructions and questions
      - But the student never see this!
...
## Assignments
- Easily export data in a more student friendly form
  - Excel, csv, shp
  - Included in the same `qmd` file as the instructions and questions
...
![Soil Texture of tour area](figs/texture_map.png){width=40%}

## Scientific publishing{.nostretch}
::::{.columns}
:::{.column width="45%"}
- Quarto manuscripts: text, data, analysis, code, etc all in one place!
- Recent publication on riparian phosphorus 
  - [Website](https://alexkoiter.ca/riparian-grazing-manuscript/)
  - [GitHub](https://github.com/alex-koiter/riparian-grazing-manuscript)

:::  
:::{.column width="55%"}
:::{.output}
![](figs/manuscript.png){fig-align=center}
:::
:::
::::
...
- **Quarto**
  ...
  - [Intro to Quarto workshop](https://github.com/steffilazerte/intro_to_quarto) [(Borrowed ideas for this presentation **Thanks!**)]{.small}
- **R Markdown**
...
code <- qrcode::qr_code("https://github.com/alex-koiter/presentations/tree/main/Quarto")
