...
- Recent publication on [riparian phosphorus](https://alexkoiter.ca/riparian-grazing-manuscript/)
...
code <- qrcode::qr_code("http://alexkoiter.ca/presentations/Quarto.html")
