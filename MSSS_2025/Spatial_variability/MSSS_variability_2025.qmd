...
::: {.column width="40%"}
![](figs/field3.jpg){fig-align="center"}
:::
...
::: {.column width="50%"}
![](figs/Soil sampling.jpg){width=75% fig-align="right"}
:::
...
::: {.column width="50%"}
![](figs/field2.jpg){width=75% fig-align="right"}
:::
...
::: {.column width="50%"}
![](figs/stream2.jpg){fig-align="right"}
...
code <- qrcode::qr_code("https://github.com/alex-koiter/presentations/tree/main/MSSS_2025/Spatial_variability")

qrcode::generate_svg(code, filename = here::here("./MSSS_2025/Spatial_variability/figs/qr.svg"))
