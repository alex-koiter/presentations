...
## Characterizing Sediment Source Variability {background-color="white" background-image="figs/background.jpg" background-size="cover"}

::: {.white .shadow style="margin-top:70px"}
### Landscape and Land Use Influences on Fingerprint Properties {.white .shadow}

**Dr. Alex Koiter**
:::

::: {style="position:absolute; bottom:0"}
 `r icons::fontawesome("globe") |> icons::icon_style(fill = "white")` [**alexkoiter.ca**](https://alexkoiter.ca){.white .shadow}<br> `r icons::fontawesome("envelope") |> icons::icon_style(fill = "white")` [**koitera\@brandonu.ca**](mailto:koitera@brandonu.ca){.white .shadow}<br> `r icons::fontawesome("github") |> icons::icon_style(fill = "white")` [**alex-koiter**](https://github.com/alex-koiter){.white .shadow}<br> `r fontawesome::fa("bluesky", fill = "white")` [**alex-koiter**](https://bsky.app/profile/alex-koiter.bsky.social){.white .shadow}<br> `r icons::fontawesome("mastodon") |> icons::icon_style(fill = "white")` [**\@alex_koiter\@sciencemastodon.com**](https://sciencemastodon.com/@Alex_Koiter){.white .shadow}<br> `r icons::fontawesome("twitter") |> icons::icon_style(fill = "white")` [**\@alex_koiter**](https://twitter.com/alex_koiter){.white .shadow}
:::
...
::: {.column width="50%"}
### Using a range of soil colour and geochemical properties accross two contrasting land uses:
...
![](figs/sampling2.jpg){fig-align="center"}    
:::
...
![](figs/sampling3_crop.jpg){fig-align="center"}     
...
<!-- code <- qrcode::qr_code("https://alexkoiter.ca/spatial-variability-soil-manuscript/") -->
